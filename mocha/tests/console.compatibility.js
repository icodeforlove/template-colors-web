...
if (Console.support.console && Console.support.consoleStyles && Console.support.consoleGroups) {
	describe('Console (Compatibility Mode, Styles, Groups)', function(){
		...
		describe('#log()', function(){
			...
			it('should work with a styled string', function() {
				expect(Console.log(F('foobar', 'red'))).to.eql(['%cfoobar%c', 'color:#de4f2a;', '']);
			});

			it('should work with multiple styled strings', function() {
				expect(Console.log(F('foo', 'red') + F('bar', 'blue'))).to.eql(["%cfoo%c%cbar%c", "color:#de4f2a;", "", "color:#1795de;", ""]);
			});

			it('should work with JSON', function() {
				expect(Console.log(F(JSON.stringify(Mocks.obj), 'json'))).to.eql(Stubs.obj);
			});
		});
		...
		describe('#group()', function(){
			...
			it('should work with a styled string', function() {
				expect(Console.group(F('foobar', 'red'))).to.eql(['%cfoobar%c', 'color:#de4f2a;', '']);
				Console.groupEnd();
			});

			it('should work with multiple styled strings', function() {
				expect(Console.group(F('foo', 'red') + F('bar', 'blue'))).to.eql(["%cfoo%c%cbar%c", "color:#de4f2a;", "", "color:#1795de;", ""]);
				Console.groupEnd();
			});

			it('should work with JSON', function() {
				expect(Console.group(F(JSON.stringify(Mocks.obj), 'json'))).to.eql(Stubs.obj);
				Console.groupEnd();
			});
		});
		...
		describe('#groupCollapsed()', function(){
			...
			it('should work with a styled string', function() {
				expect(Console.groupCollapsed(F('foobar', 'red'))).to.eql(['%cfoobar%c', 'color:#de4f2a;', '']);
				Console.groupEnd();
			});

			it('should work with multiple styled strings', function() {
				expect(Console.groupCollapsed(F('foo', 'red,underline') + F('bar', 'blue'))).to.eql(["%cfoo%c%cbar%c", "color:#de4f2a;text-decoration:underline;", "", "color:#1795de;", ""]);
				Console.groupEnd();
			});

			it('should work with JSON', function() {
				expect(Console.groupCollapsed(F(JSON.stringify(Mocks.obj), 'json'))).to.eql(Stubs.obj);
				Console.groupEnd();
			});
		});
		...
		describe('#warn()', function(){
			...
			it('should work with a styled string', function() {
				expect(Console.warn(F('foobar', 'red'))).to.eql(['%cfoobar%c', 'color:#de4f2a;', '']);
			});

			it('should work with multiple styled strings', function() {
				expect(Console.warn(F('foo', 'red,underline') + F('bar', 'blue'))).to.eql(["%cfoo%c%cbar%c", "color:#de4f2a;text-decoration:underline;", "", "color:#1795de;", ""]);
			});

			it('should work with JSON', function() {
				expect(Console.warn(F(JSON.stringify(Mocks.obj), 'json'))).to.eql(Stubs.obj);
			});
		});
		...
		describe('#info()', function(){
			...
			it('should work with a styled string', function() {
				expect(Console.info(F('foobar', 'red'))).to.eql(['%cfoobar%c', 'color:#de4f2a;', '']);
			});

			it('should work with multiple styled strings', function() {
				expect(Console.info(F('foo', 'red,underline') + F('bar', 'blue'))).to.eql(["%cfoo%c%cbar%c", "color:#de4f2a;text-decoration:underline;", "", "color:#1795de;", ""]);
			});

			it('should work with JSON', function() {
				expect(Console.info(F(JSON.stringify(Mocks.obj), 'json'))).to.eql(Stubs.obj);
			});
		});
